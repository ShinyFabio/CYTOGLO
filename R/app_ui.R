                        ...
                        card(
                          ...
                          conditionalPanel(
                            ...
                            fluidRow(
                              ...
                              column(3,
                                     fileInput("filesce_input","Load a SCE file (.rds)", accept = ".rds"),
                                     actionButton("go_to_analysis","Go to the Analysis!",icon("rocket"),style ="padding:10px; font-size:110%;"))
                            )
                          )
                        )
                      )
                        ...
                        wellPanel(
                          ...
                          fluidRow(
                            ...
                            conditionalPanel("input.nvars_gating == 'one variable'",
                                             ...
                                             radioGroupButtons("rl_1var_gat", tooltip(trigger = list("Where to cut",icon("info-circle", style="color: #1f77b4;")),
                        ...
                        card(
                          ...
                          div(
                            ...
                            div(
                              ...
                              icon("right-long", style = "font-size: 55px;")
                            ),
                  ...
                  screen(
                    ...
                    fluidRow(
                      ...
                      column(
                        9,
                        card(
                          card_header("Step 4.2: Generate and Download the SCE Object"),
                          p(paste("Load the Panel file and the Metadata file and generate a final SingleCellExperiment object, which can be downloaded and
                                  used in",golem::pkg_name(),"for the next sessions.")),

                          fluidRow(
                            column(5,
                              fileInput("panelfile","Panel file (.csv or .xlsx)"),
                              fileInput("metadatafile","Metadata file (.csv or .xlsx)")),
                            column(4,
                                   actionButton("create_sce","Create SCE",icon("gear"),style ="padding:10px; font-size:110%;"),
                                   br(),
                                   conditionalPanel(
                                     "output.check_sce_data == true",
                                     downloadButton("download_sce","Download SCE",style ="padding:10px; font-size:110%;", class = "btn-success btn-lg",icon("download")),
                                     actionButton("go_to_analysis_2","Go to the Analysis!",icon("rocket"),style ="padding:10px; font-size:110%;"))
